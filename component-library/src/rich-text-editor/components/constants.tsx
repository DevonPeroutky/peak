import { createSlatePluginsComponents, ELEMENT_CODE_BLOCK } from '@udecode/slate-plugins'
...
import { ReadOnlyCodeBlock } from '../plugins/prismjs-code-plugin/component/read-only'
...
export const PEAK_SLATE_COMPONENT_OVERRIDES = {
  ...
  [ELEMENT_CODE_BLOCK]: ReadOnlyCodeBlock
}
