        ...
        <div className={"pt-12"}>
            <div className={"flex justify-center items-center flex-col divide-gray-50 border-b pt-12"}>
                ...
                <div className={"w-full flex items-center pb-4 text-gray-600 font-light justify-between"}>
                    ...
                    <div className={"flex"}>
                        <span className={"mr-2 cursor-pointer hover:text-blue-400"} onClick={() => notify("Twitter integration coming soon", "twitter")}>
                        ...
                        <span className={"mr-2 cursor-pointer hover:text-blue-400"} onClick={() => notify("Github integration coming soon", "github")}>
                            ...
                            <span className={"mr-2 cursor-pointer hover:text-blue-400"} onClick={() => notify("Instagram integration coming soon", "insta")}>
                            ...
                            <span className={"mr-2 cursor-pointer hover:text-blue-400"} onClick={() => notify("LinkedIn integration coming soon", "linkedin")}>
